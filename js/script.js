...
const questions = [
  {
    id: 1,
    statement: [
      "Hej! Låt oss ta fram offerter åt dig. Det tar bara någon minut.",
      "Vilken tjänst är du intresserad av att få offerter på?",
    ],
    input: "button",
    placeholder: "",
    answers: [
  ...
  },
  {
    ...
    statement: [
      ...
      "En tydlig beskrivning underlättar för bättre offerter.",
    ],
    input: "textarea",
